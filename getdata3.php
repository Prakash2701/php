                        ...
                        <?php
                              ...
                              if ($result->num_rows > 0) {
                                ...
                                while ($row = $result->fetch_assoc()) {
                                 ...
                                 <td class='O' ><li><a href='.\\updata.php?id=$row[id]'> <button type='button'class='Operation'>updata</button> </a></li><a href='.\\delete.php?id=$row[id]'> <button type='button'class='Operation'>Deleta</button> </a><li></td>
                                 </tr> ";
                                }
                                echo "</table></tbody>";
                              } else {
